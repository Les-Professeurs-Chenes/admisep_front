                        ...
                        <div className="user-info-container">
                            <div className="row">
                                <div className="col">
                                    ...
                                    <input type="text" name="firstname" placeholder="Entrez votre prénom" value="Axel" />
                                </div>
                                <div className="col">
                                    <h3 className="subtitle">Nom</h3>
                                    <input type="text" name="lastname" placeholder="Entrez votre nom" value="JOSEPH-ANTOINE" />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col">
                                    <h3 className="subtitle">Email</h3>
                                    <input type="email" name="email" placeholder="Entrez votre email" value="axeljosephantoine@gmail.com" />
                                </div>
                                <div className="col">
                            ...
                            <div>
                                ...
                                <input type="number" name="promo" placeholder="Entrez votre promo" value="2023" />
                            </div>
                            <div>
